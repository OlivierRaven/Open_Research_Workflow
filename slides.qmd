...
`.gitignore` keeps `outputs/`, raw data, and OS files out of version control 
...
The published DOI never moves. That's not a limitation — it's the anchor everything else hangs off.
...
::: {.incremental}
- A missing `renv.lock` or a typo fix, added as v1.1
- A reviewer's follow-up question, finally answered — v1.2
- Next season's data, reanalysed — v1.3
